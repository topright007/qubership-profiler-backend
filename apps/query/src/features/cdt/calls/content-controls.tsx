...
const ContentControls = () => {
    ...
    return (
        <div className={classNames.contentControls}>
            ...
            <Tooltip
                title={
                    <div className={classNames.codeExample} style={{ padding: '5px', paddingLeft: '15px' }}>
                        <ul>
                            <li>
                                <code>+clust1 user5 admin</code> lists all <code>(user5 OR admin)</code> made to <code>clust1</code> node
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <br />
                                lists http <code>GET</code> requests of <code>(user5 or admin)</code> except <code>/health</code>
                            </li>
                            <li>
            ...
            >
                <span className={classNames.searchTips}>
                    <Input.Search
                        value={query}
                        onChange={e => {
